...
## Membre du Projet : Shun Lembrez Thibaut Romain Verbeare Aurelien

### Description de SAE S2-01 :

Nous avons réalisé un projet de développement d'une application de gestion de tâches en Java. Permettant des gerer des clients, entrepots et des commandes. D'une entreprise O-de-france qui vend des boutteilles de eau.

#### Pour Lancer les Tests Question 6:
```bash
./gradlew test
```
